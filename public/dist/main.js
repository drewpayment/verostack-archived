...
var AgentRulesDialogComponent = /** @class */ (function () {
    function AgentRulesDialogComponent(data, ref, fb) {
        this.data = data;
        this.ref = ref;
        this.fb = fb;
    }
