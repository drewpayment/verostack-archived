...
module.exports = "table {\n  width: 100%; }\n\ntr.detail-row {\n  height: 0; }\n\ntr.element-row:not(.expanded-row):hover {\n  background: #f5f5f5; }\n\ntr.element-row:not(.expanded-row):active {\n  background: #efefef; }\n\n.element-row td {\n  border-bottom-width: 0; }\n\n.element-detail {\n  min-height: 48px;\n  overflow: hidden;\n  display: flex; }\n\n.expanded {\n  background: #f7f8fc; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var PayrollListComponent = /** @class */ (function () {
    ...
    PayrollListComponent.prototype.isAllSelected = function () {
        ...
        var numRows = this._payrolls.filter(function (p) { return !p.isReleased && !p.payCycle.isClosed; }).length;
    ...
    /** not used */
    PayrollListComponent.prototype.scheduleAutoRelease = function () {
        var dates = this.selection.selected.filter(function (p) { return p.automatedRelease != null; }).map(function (p) { return p.automatedRelease; });
        var selectedDate = this.getLatestDate(dates);
        this.dialog.open(_schedule_auto_release_dialog_schedule_auto_release_dialog_component__WEBPACK_IMPORTED_MODULE_15__["ScheduleAutoReleaseDialogComponent"], {
            width: '40vw',
            data: {
                date: selectedDate
            }
    ...
    PayrollListComponent.prototype.getLatestDate = function (dates) {
        if (!dates.length)
            return;
        return dates.reduce(function (a, c, i) { return (c > a) && i ? c : a; });
    };
    /**
    ...
    PayrollListComponent.prototype.showReleaseConfirm = function () {
        var _this = this;
        this.dialog.open(_confirm_release_dialog_confirm_release_dialog_component__WEBPACK_IMPORTED_MODULE_17__["ConfirmReleaseDialogComponent"], {
            width: '50vw',
            data: {
